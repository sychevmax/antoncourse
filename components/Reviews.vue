      ...
      .reviewsItem__inner.gridContainer
        ...
        .reviewsItem__content.gridContainer__cell._span-7._offset-2._span-md-7._offset-md-2._span-sm-5._offset-sm-1._span-xs-3
          ...
          a.reviewsItem__link(href="https://www.instagram.com/elmielmiee/" target="_blank")
            img(src="/img/course_psy/review_1.png")
            span @elmielmiee
    .reviewsItem
      .reviewsItem__inner.gridContainer
        .reviewsItem__icon.gridContainer__cell._span-2._span-md-2._span-sm-1
        ...
        .reviewsItem__content.gridContainer__cell._span-7._offset-2._span-md-7._offset-md-2._span-sm-5._offset-sm-1._span-xs-3
          ...
          a.reviewsItem__link(href="https://www.instagram.com/svetlana__rani/" target="_blank")
            img(src="/img/course_psy/review_2.png")
            span @svetlana__rani
    .reviewsItem
      .reviewsItem__inner.gridContainer
        .reviewsItem__icon.gridContainer__cell._span-2._span-md-2._span-sm-1
        ...
        .reviewsItem__content.gridContainer__cell._span-7._offset-2._span-md-7._offset-md-2._span-sm-5._offset-sm-1._span-xs-3
          ...
          a.reviewsItem__link(href="https://www.instagram.com/stacy__moonlightt/" target="_blank")
            img(src="/img/course_psy/review_3.png")
            span @stacy__moonlightt
    .reviewsItem
      .reviewsItem__inner.gridContainer
        .reviewsItem__icon.gridContainer__cell._span-2._span-md-2._span-sm-1
          img(src="/img/about/quotes_icon.svg")
      ...
      .reviewsItem__inner.gridContainer
        ...
        .reviewsItem__content.gridContainer__cell._span-7._offset-2._span-md-7._offset-md-2._span-sm-5._offset-sm-1._span-xs-3
          ...
          a.reviewsItem__link(href="https://www.instagram.com/ylia_ttt/" target="_blank")
            img(src="/img/course_psy/review_4.png")
            span @ylia_ttt
    .reviewsItem
      .reviewsItem__inner.gridContainer
        .reviewsItem__icon.gridContainer__cell._span-2._span-md-2._span-sm-1
        ...
        .reviewsItem__content.gridContainer__cell._span-7._offset-2._span-md-7._offset-md-2._span-sm-5._offset-sm-1._span-xs-3
          .reviewsItem__text
            p Здравствуйте, хочу написать отзыв о сеансе с Светланой из Вашей команды... я его и ей написала лично и дублирую его сюда...
            p Очень понравился сегодняшний сеанс!! Было очень интересно увидеть и прочувствовать события которые происходили когда я была ещё в животике у мамы ..!!! Как это было приятно (после того как все разрешилось )) !!! Очень интересный опыт и я рада что его прожила с тобой !!! Я сейчас чувствую спокойствие и беззаботность с радостью! Светлана я тебе очень БЛАГОДАРНА !!! ❤️❤️❤️❤️❤️❤️❤️
          a.reviewsItem__link(href="https://www.instagram.com/juliezagoret/" target="_blank")
            img(src="/img/course_psy/review_5.png")
            span @juliezagoret
</template>
