  ...
  .course__program
    .courseProgram.gridContainer.container
      ...
      .courseProgram__description.gridContainer__cell._span-10._offset-1._span-md-10._offset-md-1._span-sm-10
        p(v-html='$t("pages.courses.unpacking.program.description")')
